...
def load_custom_csv(filepath_or_buffer) -> pd.DataFrame:
    """
    Loads a custom CSV file (e.g. Kaggle creditcard.csv dataset).
    Validates required columns: Time, Amount, V1..V28, Class.
    """
